...
class AnnotatedDialog extends Dialog {
    ...
    showSpeechBubble(content) {
        ...
        this.speechBubble.style.left = `${rect.left + window.scrollX + (rect.width - bubbleRect.width) / 2}px`;
        this.speechBubble.style.top = `${rect.top + window.scrollY - bubbleRect.height - 10}px`;
