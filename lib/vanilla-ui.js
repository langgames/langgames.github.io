...
class Dialog {
    ...
    attacheMenuToDialog() {
        ...
        this.dialog.classList.add(`from-${this.direction}`);

        // Trigger the animation
        setTimeout(() => {
            this.dialog.classList.remove(`from-${this.direction}`);
    ...
    show(text = '', editable = false, direction = 'bottom') {
        ...
        this.menu.style.top = this.menu.style.bottom = undefined
        this.menu.style[direction] = "-2px"
